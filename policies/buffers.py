...
class RolloutBuffer(BaseBuffer):
    ...
    def __init__(
        ...
        self.interventions, self.costs, self.cost_returns = None, None, None
    ...
    def reset(self) -> None:
        ...
        self.interventions = np.zeros((self.buffer_size, self.n_envs), dtype=np.bool)
        self.generator_ready = False
    ...
    def add(
            self, obs: np.ndarray, action: np.ndarray, reward: np.ndarray, done: np.ndarray, value: torch.Tensor, log_prob: torch.Tensor, intervention: bool
    ) -> None:
        """
        ...
        self.interventions[self.pos] = np.array(intervention).copy()
        self.pos += 1
    ...
    def _get_samples(self, batch_inds: np.ndarray) -> RolloutBufferSamples:
        data = (
            ...
            self.interventions[batch_inds].flatten()
        )
